...
public class TestLambda {
    ...
    public static void main(String[] args) {
       ...
       List<String> result2 = Lambda.allMatches(list2, l->l.toString().charAt(0)=='h');
         System.out.println(result2);

        //Retourner une liste qui contient la taille de chacune des String de la liste originale
        List<Integer> result3 = Lambda.transformAll(list2,l->l.toString().length() );
       System.out.println(result3);


       List<String> list3 = Arrays.asList("hello", "honjour", "goeiedag", "hallo", "hej");

        //Trouve toutes les String de la liste qui commencent par "h"
        List<String> result4 = Lambda.filter(list3, l->l.toString().charAt(0)=='h');
        System.out.println(result4);

        //Retourner une liste qui contient la taille de chacune des String de la liste originale
        List<Integer> result5 = Lambda.map(list3,l->l.toString().length() );
